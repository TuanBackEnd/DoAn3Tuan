...
// Loại giày
Route::get('/admin/loaigiay', [LoaiGiayController::class, 'show']);
Route::get('/admin/loaigiay/loaigiay', [LoaiGiayController::class, 'show']);
Route::get('/admin/loaigiay/them', [AdminController::class, 'dieuhuong2'])->setDefaults(['slug' => 'loaigiay', 'slug2' => 'them']);
...
Route::post('/admin/them-chitiet-giay', [ChiTietGiayController::class, 'store'])->name('chitietgiay.store');
