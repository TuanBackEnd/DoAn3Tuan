...
<body style="padding: 0; margin: 0;">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <a class="navbar-brand me-2" href="/"><img src="{{ URL('images1/logo.png') }}" height="35" alt="ĐỒ ÁN WEB SHOP"
                    loading="lazy"></a>
            ...
            <div class="collapse navbar-collapse" id="navbarButtons">
                ...
                <div class="d-flex align-items-center float-right">
                    <a href="/"><button type="button" class="btn btn-link px-3 me-2 fs-5">TRANG CHỦ</button></a>
                    <a href="/cua-hang"><button type="button" class="btn btn-link px-3 me-2 fs-5">CỬA HÀNG</button></a>
                    <a href="/gioi-thieu"><button type="button" class="btn btn-link px-3 me-2 fs-5">GIỚI
                            THIỆU</button></a>
                    <a href="/thanh-toan"><button type="button" class="btn btn-link px-3 me-2 fill-stone-200 fs-5">THANH
                            TOÁN</button></a>
                    ...
                    {{-- @if (Route::has('login'))
						@auth
							<div class="dropdown">
								<button class="btn btn-primary dropdown-toggle fs-5" type="button" id="dropdownMenuButton" data-mdb-toggle="dropdown" aria-expanded="false">
								...
								<ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
									<form method="POST" action="{{ route('logout') }}">
                                        @csrf
                                        <li><a class="dropdown-item fs-5" href="/tai-khoan">Tài khoản</a></li>
                                        <!-- <li><a class="dropdown-item" href="/lichsu">Lịch sử mua hàng</a></li> -->
            ...
            <div class="container text-center text-md-start mt-5">
                <div class="row mt-3">
                    <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                        ...
                        <p><i class="fas fa-home me-3"></i> QUẬN 1 HCM, Việt Nam</p>
                        <p>
                            <i class="fas fa-envelope me-3"></i> TUANPHUSHOP@gmail.com
                        </p>
                        <p><i class="fas fa-phone me-3"></i> +84 899999999</p>
                    </div>
    ...
    <!-- Scripts -->
    <script>
        // NOTE: Rating input is initialized inside the product detail page when the Rating tab is shown.
        // Keeping this block empty avoids double-init issues.
        $(function() {});
