                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card shadow">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a href="/admin/tonkho" type="button" class="btn btn-success">Quản Lý Tồn Kho</a>
                                            ...
                                            <tbody>
                                                @foreach ($giays as $giay)
                                                    <tr>
                                                        ...
                                                        <td>{{$giay['don_gia']}}</td>
                                                        <td>
                                                            <img src="/storage/images/{{$giay['hinh_anh_1']}}"
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="/admin/them-chitiet-giay/{{$giay['id_giay']}}" type="button"
                                                                class="btn btn-info btn-rounded">Chi Tiết</a>
